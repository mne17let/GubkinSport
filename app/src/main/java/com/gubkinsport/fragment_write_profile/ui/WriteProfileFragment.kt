...
import com.gubkinsport.fragment_write_profile.helpers.ProfileValidationHelper
import com.gubkinsport.fragment_write_profile.helpers.SendProfileDataHelper_FB

class WriteProfileFragment: Fragment(R.layout.fragment_create_profile) {

    private lateinit var viewModel: WriteProfileViewModel
